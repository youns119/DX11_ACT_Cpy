...
namespace DX
{
    ...
    void XM_CALLCONV DrawCapsule2D(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
        DirectX::FXMVECTOR origin, DirectX::FXMVECTOR majorAxis, DirectX::FXMVECTOR minorAxis, float height,
        DirectX::GXMVECTOR color = DirectX::Colors::White);

    void XM_CALLCONV DrawCapsule3D(DirectX::PrimitiveBatch<DirectX::VertexPositionColor>* batch,
        DirectX::FXMVECTOR origin, DirectX::FXMVECTOR direction, float radius, float height,
        DirectX::FXMVECTOR color = DirectX::Colors::White);
}