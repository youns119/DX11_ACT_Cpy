...
class CUI_StretchBar final : public CUI
{
public:
	struct DESC
	{
...
protected:
	CUI_StretchBar(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_StretchBar(const CUI_StretchBar& Prototype);
	virtual ~CUI_StretchBar() = default;
...
public:
	static CUI_StretchBar* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
