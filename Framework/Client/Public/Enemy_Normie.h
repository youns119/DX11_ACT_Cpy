...
private:
	CEnemy_Normie(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnemy_Normie(const CEnemy_Normie& Prototype);
	virtual ~CEnemy_Normie() = default;
...
public:
	static CEnemy_Normie* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
