...
class CPlayerState_Parry final
    : public CAnimState
{
...
public:
    static CPlayerState_Parry* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, CStateMachine* pOwner, PlayerStateFlags* pPlayerState);
