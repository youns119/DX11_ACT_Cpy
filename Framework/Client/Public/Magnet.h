...
public:
	// enum MAGNETEFFECT { PULL_RANGE, METAL_SCRAP, EFFECT_END };
...
private:
	void Call_Spark(_float fTimeDelta);
...
private:
	// CEffectObject*		m_pMagnetPullEffect[EFFECT_END];
	_float				m_fSparkTime = {};
	_float				m_fSparkTimeAcc = {};
