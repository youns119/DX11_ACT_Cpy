...
BEGIN(Client)
class CPinBall_Flip_L final : public CGameObject, public IInteractive_Bounceable
{
...
private:
	CPinBall_Flip_L(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CPinBall_Flip_L(const CPinBall_Flip_L& _Prototype);
	virtual ~CPinBall_Flip_L() = default;
...
public:
	static CPinBall_Flip_L* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
