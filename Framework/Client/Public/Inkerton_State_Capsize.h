...
class CInkerton_State_Capsize final : public CState
{
	using super = CState;

private:
	CInkerton_State_Capsize();
	virtual ~CInkerton_State_Capsize() = default;
...
public:
	static CInkerton_State_Capsize* Create(void* pArg);
