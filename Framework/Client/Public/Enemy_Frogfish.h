...
private:
	CEnemy_Frogfish(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEnemy_Frogfish(const CEnemy_Frogfish& Prototype);
	virtual ~CEnemy_Frogfish() = default;
...
public:
	static CEnemy_Frogfish* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
