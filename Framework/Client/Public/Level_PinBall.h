...
BEGIN(Client)
class CLevel_PinBall final : public CLevel
{
	using super = CLevel;
private:
	CLevel_PinBall(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_PinBall() = default;
...
public:
	static CLevel_PinBall* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
