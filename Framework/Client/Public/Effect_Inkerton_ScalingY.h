...
class CEffect_Inkerton_ScalingY final : public CMeshEffect
{
	using super = CMeshEffect;

private:
	CEffect_Inkerton_ScalingY(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Inkerton_ScalingY(const CEffect_Inkerton_ScalingY& Prototype);
	virtual ~CEffect_Inkerton_ScalingY() = default;
...
public:
	static CEffect_Inkerton_ScalingY* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
