...
BEGIN(Client)
class CPinBall_Spliter_L final : public CGameObject, public IInteractive_Bounceable
{
...
private:
	CPinBall_Spliter_L(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CPinBall_Spliter_L(const CPinBall_Spliter_L& _Prototype);
	virtual ~CPinBall_Spliter_L() = default;
...
public:
	static CPinBall_Spliter_L* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
