...
class CEffect_Inkerton_Increase final : public CMeshEffect
{
	using super = CMeshEffect;

private:
	CEffect_Inkerton_Increase(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Inkerton_Increase(const CEffect_Inkerton_Increase& Prototype);
	virtual ~CEffect_Inkerton_Increase() = default;
...
public:
	static CEffect_Inkerton_Increase* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
