...
class CEffect_Mesh_Once final : public CMeshEffect
{
	using super = CMeshEffect;

private:
	CEffect_Mesh_Once(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Mesh_Once(const CEffect_Mesh_Once& Prototype);
	virtual ~CEffect_Mesh_Once() = default;
...
public:
	static CEffect_Mesh_Once* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
