...
class CUI_FixStretchBarEffect final : public CUI
{
public:
	struct DESC
	{
...
protected:
	CUI_FixStretchBarEffect(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUI_FixStretchBarEffect(const CUI_FixStretchBarEffect& Prototype);
	virtual ~CUI_FixStretchBarEffect() = default;
...
public:
	static CUI_FixStretchBarEffect* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
