...
class CLevel_CrabTomb final : public CLevel
{
	using super = CLevel;
private:
	CLevel_CrabTomb(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CLevel_CrabTomb() = default;
...
public:
	static CLevel_CrabTomb* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
