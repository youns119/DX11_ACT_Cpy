...
class CBeach_Terrain final : public CGameObject
{
...
private:
	CBeach_Terrain(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CBeach_Terrain(const CBeach_Terrain& Prototype);
	virtual ~CBeach_Terrain() = default;
...
public:
	static CBeach_Terrain* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
