...
class CEffect_Roland_Increase final : public CMeshEffect
{
	using super = CMeshEffect;

private:
	CEffect_Roland_Increase(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEffect_Roland_Increase(const CEffect_Roland_Increase& Prototype);
	virtual ~CEffect_Roland_Increase() = default;
...
public:
	static CEffect_Roland_Increase* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
