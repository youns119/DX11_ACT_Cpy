...
CSplitter_State_Patrol::CSplitter_State_Patrol()
{
}

HRESULT CSplitter_State_Patrol::Initialize(void* pObj)
{
#ifdef _DEBUG
	...
	m_pParolPoints = static_cast<CEnemy_Splitter*>(pObj)->Get_PatrolPoints();
...
void CSplitter_State_Patrol::Enter(void* pObj)
{	
...
void CSplitter_State_Patrol::Update(_float fTimeDelta, void* pObj)
{			
	...
	if (fDis < 1.f) {
		...
		m_pTransform->Go_Straight(fTimeDelta * 0.5f);
	}

	__super::Update(fTimeDelta, pObj);
}

void CSplitter_State_Patrol::Exit(void* pObj)
{
	__super::Exit(pObj);
}

CSplitter_State_Patrol* CSplitter_State_Patrol::Create(void* pArg)
{
	CSplitter_State_Patrol* pInstance = new CSplitter_State_Patrol();
...
void CSplitter_State_Patrol::Free()
{
	__super::Free();
}