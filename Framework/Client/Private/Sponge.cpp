...
{
    m_pGameInstance->Play_Sound(L"Sponge.wav", (_uint)SOUND_CHANNEL::MAPOBJECT, 0.3f);
    ...
    // m_pGameInstance->Call_Effect((_uint)EFFECT_TYPE::PTCL_SANDBURST)
}
...
HRESULT CSponge::Ready_Components()
{
    ...
    /* Com_Collider */
    {
        ...
        Desc.ColliderDesc.iCollisionGroup = (_uint)COLLISION_GROUP::SPONGE; // 나중에 바꾸거나 할고.
