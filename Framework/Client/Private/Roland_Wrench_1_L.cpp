...
CRoland_Wrench_1_L::CRoland_Wrench_1_L(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: super(pDevice, pContext)
{
}

CRoland_Wrench_1_L::CRoland_Wrench_1_L(const CRoland_Wrench_1_L& Prototype)
	: super(Prototype)
{
}

HRESULT CRoland_Wrench_1_L::Initialize_Prototype()
{
...
HRESULT CRoland_Wrench_1_L::Initialize(void* pArg)
{
	DESC* pDesc = static_cast<DESC*>(pArg);

	if (pDesc == nullptr)
	{
		MSG_BOX("Failed To Create : CRoland_Wrench_1_L");
		return E_FAIL;
	}
	else {
...
void CRoland_Wrench_1_L::Priority_Update(_float fTimeDelta)
{
	__super::Priority_Update(fTimeDelta);
}

void CRoland_Wrench_1_L::Update(_float fTimeDelta)
{
...
void CRoland_Wrench_1_L::Late_Update(_float fTimeDelta)
{
...
HRESULT CRoland_Wrench_1_L::Render()
{
	if (!m_isActive)
		return S_OK;
...
void CRoland_Wrench_1_L::On_CollisionEnter(CGameObject* pOther, _uint iGroup)
{
...
void CRoland_Wrench_1_L::On_Collision(CGameObject* pOther, _uint iGroup)
{
}

void CRoland_Wrench_1_L::On_CollisionExit(CGameObject* pOther, _uint iGroup)
{
}

void CRoland_Wrench_1_L::Parried()
{
	dynamic_cast<IParried*>(m_pOwner)->Parried();
}

HRESULT CRoland_Wrench_1_L::Load_From_File(const _char* szFilePath, CModel* pModel)
{
...
HRESULT CRoland_Wrench_1_L::Ready_Components()
{
	// Com_Model
	if (FAILED(Add_Component(LEVEL_STATIC, L"Prototype_Component_Model_Roland_Wrench_1_L",
...
HRESULT CRoland_Wrench_1_L::Bind_ShaderResources()
{
...
CRoland_Wrench_1_L* CRoland_Wrench_1_L::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CRoland_Wrench_1_L* pInstance = new CRoland_Wrench_1_L(pDevice, pContext);
...
CCloneable* CRoland_Wrench_1_L::Clone(void* pArg)
{
	CRoland_Wrench_1_L* pInstance = new CRoland_Wrench_1_L(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Clone : CRoland_Wrench_1_L");
		Safe_Release(pInstance);
	}
