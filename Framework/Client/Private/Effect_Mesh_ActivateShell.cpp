...
CEffect_Mesh_ActivateShell::CEffect_Mesh_ActivateShell(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: super(pDevice, pContext)
{
}

CEffect_Mesh_ActivateShell::CEffect_Mesh_ActivateShell(const CEffect_Mesh_ActivateShell& Prototype)
	: super(Prototype)
{
}

HRESULT CEffect_Mesh_ActivateShell::Initialize_Prototype()
{
...
HRESULT CEffect_Mesh_ActivateShell::Initialize(void* pArg)
{
	...
	m_vOriginScale = _float3(70.f, 70.f, 70.f);
	m_vTargetScale = _float3(55.f, 55.f, 55.f);
	m_pTransformCom->Set_Scale(m_vOriginScale);

	return S_OK;
}

void CEffect_Mesh_ActivateShell::Priority_Update(_float fTimeDelta)
{
	Compute_CamDistance();
}

void CEffect_Mesh_ActivateShell::Update(_float fTimeDelta)
{
	if (false == m_isActive)
		return;
	...
	_vector vScale = XMVectorLerp(XMLoadFloat3(&m_vOriginScale), XMLoadFloat3(&m_vTargetScale), m_fLifeTimeAcc / m_fLifeTime);
...
void CEffect_Mesh_ActivateShell::Late_Update(_float fTimeDelta)
{
	if (false == m_isActive)
		return;
...
HRESULT CEffect_Mesh_ActivateShell::Render()
{
...
HRESULT CEffect_Mesh_ActivateShell::Render_Revealage()
{
	if (m_pAdoptedMatrix == nullptr)
	{
		if (FAILED(m_pTransformCom->Bind_WorldMatrix_To_Shader(m_pShaderCom, "g_WorldMatrix")))
...
HRESULT CEffect_Mesh_ActivateShell::Render_Distortion()
{
	if (m_pAdoptedMatrix == nullptr)
	{
		if (FAILED(m_pTransformCom->Bind_WorldMatrix_To_Shader(m_pShaderCom, "g_WorldMatrix")))
...
HRESULT CEffect_Mesh_ActivateShell::Ready_Components(const _wstring& strModelTag, const _wstring& strTextureTag, LEVELID eLevelID)
{
	/* Com_Shader */
...
_bool CEffect_Mesh_ActivateShell::Call_Trigger_Event(_float fTimeDelta)
{

	return false;
}

CEffect_Mesh_ActivateShell* CEffect_Mesh_ActivateShell::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CEffect_Mesh_ActivateShell* pInstance = new CEffect_Mesh_ActivateShell(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed To Created : CEffect_Mesh_ActivateShell");
...
CCloneable* CEffect_Mesh_ActivateShell::Clone(void* pArg)
{
	CEffect_Mesh_ActivateShell* pInstance = new CEffect_Mesh_ActivateShell(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Clone : CEffect_Mesh_ActivateShell");
		Safe_Release(pInstance);
	}
...
void CEffect_Mesh_ActivateShell::Free()
{
	super::Free();
