...
CRoland_Wrench_1_R::CRoland_Wrench_1_R(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: super(pDevice, pContext)
{
}

CRoland_Wrench_1_R::CRoland_Wrench_1_R(const CRoland_Wrench_1_R& Prototype)
	: super(Prototype)
{
}

HRESULT CRoland_Wrench_1_R::Initialize_Prototype()
{
...
HRESULT CRoland_Wrench_1_R::Initialize(void* pArg)
{
	DESC* pDesc = static_cast<DESC*>(pArg);

	if (pDesc == nullptr)
	{
		MSG_BOX("Failed To Create : CRoland_Wrench_1_R");
		return E_FAIL;
	}
	else {
...
void CRoland_Wrench_1_R::Priority_Update(_float fTimeDelta)
{
	__super::Priority_Update(fTimeDelta);
}

void CRoland_Wrench_1_R::Update(_float fTimeDelta)
{
...
void CRoland_Wrench_1_R::Late_Update(_float fTimeDelta)
{
...
HRESULT CRoland_Wrench_1_R::Render()
{
	if (!m_isActive)
		return S_OK;
...
void CRoland_Wrench_1_R::On_CollisionEnter(CGameObject* pOther, _uint iGroup)
{
...
void CRoland_Wrench_1_R::On_Collision(CGameObject* pOther, _uint iGroup)
{
}

void CRoland_Wrench_1_R::On_CollisionExit(CGameObject* pOther, _uint iGroup)
{
}

void CRoland_Wrench_1_R::Parried()
{
	dynamic_cast<IParried*>(m_pOwner)->Parried();
}

HRESULT CRoland_Wrench_1_R::Load_From_File(const _char* szFilePath, CModel* pModel)
{
...
HRESULT CRoland_Wrench_1_R::Ready_Components()
{
	// Com_Model
	if (FAILED(Add_Component(LEVEL_STATIC, L"Prototype_Component_Model_Roland_Wrench_1_R",
...
HRESULT CRoland_Wrench_1_R::Bind_ShaderResources()
{
...
CRoland_Wrench_1_R* CRoland_Wrench_1_R::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CRoland_Wrench_1_R* pInstance = new CRoland_Wrench_1_R(pDevice, pContext);
...
CCloneable* CRoland_Wrench_1_R::Clone(void* pArg)
{
	CRoland_Wrench_1_R* pInstance = new CRoland_Wrench_1_R(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed To Clone : CRoland_Wrench_1_R");
		Safe_Release(pInstance);
	}
