...
CGumpounder_State_Patrol::CGumpounder_State_Patrol()
{
}

HRESULT CGumpounder_State_Patrol::Initialize(void* pObj)
{
#ifdef _DEBUG
	...
	m_pParolPoints = static_cast<CEnemy_Gumpounder*>(pObj)->Get_PatrolPoints();
...
void CGumpounder_State_Patrol::Enter(void* pObj)
{	
	m_pMovement = static_cast<CMovement*>(static_cast<CGameObject*>(pObj)->Find_Component(TEXT("Com_Movement")));

	m_pModel->SetUp_Animation((_uint)GUMPOUNDER_ANIM_INDEX::PATROL, true, 0.3f);

	__super::Enter(pObj);
}

void CGumpounder_State_Patrol::Update(_float fTimeDelta, void* pObj)
{			
...
void CGumpounder_State_Patrol::Exit(void* pObj)
{
	__super::Exit(pObj);
}

CGumpounder_State_Patrol* CGumpounder_State_Patrol::Create(void* pArg)
{
	CGumpounder_State_Patrol* pInstance = new CGumpounder_State_Patrol();
...
void CGumpounder_State_Patrol::Free()
{
	__super::Free();
}