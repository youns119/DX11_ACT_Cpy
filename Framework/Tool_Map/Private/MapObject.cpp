...
HRESULT CMapObject::Initialize(void* _pArg)
{
    ...
    m_fFrustumRange = (pDesc->GameObjectDesc).fSpeedPerSec;//따로 변수 만들기 싫어서 그냥 스피드에 담았어요 저장하기도 그나마 쉽고
...
HRESULT CMapObject::Ready_Components()
{
    ...
    /* Com_Model */
    if (FAILED(__super::Add_Component(LEVEL_STATIC, m_strName,
...
CCloneable* CMapObject::Clone(void* _pArg)
{
