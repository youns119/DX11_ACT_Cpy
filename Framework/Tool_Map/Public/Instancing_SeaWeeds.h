...
class CInstancing_SeaWeeds final : public CGameObject
{
public:
	struct DESC
	{
...
private:
	CInstancing_SeaWeeds(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CInstancing_SeaWeeds(const CInstancing_SeaWeeds& Prototype);
	virtual ~CInstancing_SeaWeeds() = default;
...
public:
	static CInstancing_SeaWeeds* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
