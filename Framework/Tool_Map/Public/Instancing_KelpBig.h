...
class CInstancing_KelpBig final : public CGameObject
{
public:
	struct DESC
	{
...
private:
	CInstancing_KelpBig(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CInstancing_KelpBig(const CInstancing_KelpBig& Prototype);
	virtual ~CInstancing_KelpBig() = default;
...
private:
	...
	_vec3	m_vBendFactor = { 0.1f, 0.f, 0.1f };
...
public:
	static CInstancing_KelpBig* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
