...
{
	// Texture_Diffuse
	if (FAILED(super::Add_Component(LEVELID::LEVEL_STATIC, TEXT("Texture_Terrain"),
		TEXT("Com_Texture_Diffuse"), reinterpret_cast<CComponent**>(&m_TextureComs[(_uint)TEXTURE_TYPE::DIFFUSE]))))
		return E_FAIL;

	// Texture_Mask
	if (FAILED(super::Add_Component(LEVELID::LEVEL_STATIC, TEXT("Texture_Mask"),
		TEXT("Com_Texture_Mask"), reinterpret_cast<CComponent**>(&m_TextureComs[(_uint)TEXTURE_TYPE::MASK]))))
		return E_FAIL;

	// Texture_Brush
	if (FAILED(super::Add_Component(LEVELID::LEVEL_STATIC, TEXT("Texture_Brush"),
		TEXT("Com_Texture_Brush"), reinterpret_cast<CComponent**>(&m_TextureComs[(_uint)TEXTURE_TYPE::BRUSH]))))
		return E_FAIL;

	// Shader
	if (FAILED(super::Add_Component(LEVELID::LEVEL_STATIC, TEXT("Shader_VtxNorTex"),
		TEXT("Com_Shader"), reinterpret_cast<CComponent**>(&m_pShaderCom))))
		return E_FAIL;

	// VIBuffer
	if (FAILED(super::Add_Component(LEVELID::LEVEL_STATIC, TEXT("VIBuffer_Terrain"),
